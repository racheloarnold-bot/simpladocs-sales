# QBR Scheduling Email Sequence

**From:** Rachel Arnold, Head of Sales — SimplaDocs  
**To:** Current clients / POCs  
**Goal:** Schedule a Quarterly Business Review  
**Sequence length:** 5 emails  
**Recommended cadence:** Email 1 → +4 days → +4 days → +5 days → +7 days

---

## What QBRs cover (internal reference)

- Relationship check-in
- Review everything we've accomplished this quarter
- Current state assessment & understanding strategic priorities
- Roadmap & personalized recommendations
- Open floor
...
**Send day:** Day 5 (+4 days)  
**Subject:** Re: Q3 QBR — let's get something on the calendar
...
**Send day:** Day 9 (+4 days)  
**Subject:** What I'm bringing to the QBR
...
**Send day:** Day 21 (+7 days)  
**Subject:** last try on the QBR
...
- **Scheduling link:** Replace `{{scheduling link placeholder}}` with Calendly, Google Calendar link, or whatever Rachel is using
- **Personalization:** `{{First Name}}` should auto-populate from HubSpot enrollment
- **Timing:** Adjust send cadence based on account tier — higher-touch accounts may warrant shorter gaps between emails
- **Enroll in HubSpot:** Build as a HubSpot sequence so opens/clicks inform outreach prioritization
